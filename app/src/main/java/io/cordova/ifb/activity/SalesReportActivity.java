...
public class SalesReportActivity extends AppCompatActivity {
    ArrayList<SalesModule>itemList=new ArrayList<>();
    ...
    private void initialize(){
        ...
        prefManager=new PrefManager(SalesReportActivity.this);
        rvReport=(RecyclerView)findViewById(R.id.rvReport);
        LinearLayoutManager layoutManager
                = new LinearLayoutManager(SalesReportActivity.this, LinearLayoutManager.VERTICAL, false);
    ...
    private void getItemlist(){
        ...
        String surl =  AppController.APIV2URL+"api/get_EmployeeDummyActualSalesReport?UserID="+prefManager.getUserId()+"&FinancialYear="+financialYear+"&Month="+month+"&Operation=1&SecurityCode="+prefManager.getSecurityCode();
                        ...
                        try {
                            ...
                            if (responseStatus) {
                                ...
                                for (int i = 0; i < responseData.length(); i++) {
                                    ...
                                    String TicketNo=obj.optString("TicketNumber");
                                    String TokenNo=obj.optString("TokenNo");
                                    String Status=obj.optString("ApprovalStatus");
                                    String _SalesDate=obj.optString("SalesEntryDate");
                                    String Remarks=obj.optString("CRMRemarks");
                                    String InvoiceFileNameURL=obj.optString("InvoiceFileNameURL");
                                    ...
                                    SalesModule obj2 = new SalesModule(_SalesDate,TicketNo,TokenNo,ModelName,ModelCode,CustomerName,CustomerPhNo,CustomerEmail,Status,Remarks,InvoiceFileNameURL,SerialNo);
                                    itemList.add(obj2);
                            ...
                            e.printStackTrace();
                            Toast.makeText(SalesReportActivity.this, "Volly Error", Toast.LENGTH_LONG).show();
                        }
...
//        requestQueue.add(stringRequest);
        RequestQueue requestQueue =
                AppController.getUnsafeOkHttpQueue(SalesReportActivity.this);
    ...
    private void setAdapter(){
        SalesReportAdapter sAdpater=new SalesReportAdapter(itemList,SalesReportActivity.this);
    ...
    private void onClick(){
        ...
        imgHome.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(SalesReportActivity.this,DashBoardActivity.class);
    ...
    private void searchDialog() {
        AlertDialog.Builder dialogBuilder = new AlertDialog.Builder(SalesReportActivity.this, R.style.CustomDialogNew);
