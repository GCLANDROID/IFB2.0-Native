...
import io.cordova.ifb.adapter.DummySalesReportAdapter;
import io.cordova.ifb.module.DummySalesModule;
import io.cordova.ifb.utility.AppController;
import io.cordova.ifb.utility.PrefManager;

public class DummySaleReportActivity extends AppCompatActivity {
    ArrayList<DummySalesModule> itemList=new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dummy_sale_report);
        initialize();
        getItemlist();
        setAdapter();
        onClick();
    ...
    private void initialize(){
        prefManager=new PrefManager(DummySaleReportActivity.this);
        rvReport=(RecyclerView)findViewById(R.id.rvReport);
        LinearLayoutManager layoutManager
                = new LinearLayoutManager(DummySaleReportActivity.this, LinearLayoutManager.VERTICAL, false);
    ...
    private void getItemlist(){
                        ...
                        try {
                            ...
                            if (responseStatus) {
                                ...
                                for (int i = 0; i < responseData.length(); i++) {
                                    ...
                                    DummySalesModule obj2 = new DummySalesModule(_SalesDate,TicketNo,TokenNo,ModelName,ModelCode,CustomerName,CustomerPhNo,CustomerEmail,Status,Remarks,TempNo,CategoryName,ModelCode);
                                    itemList.add(obj2);
                            ...
                            e.printStackTrace();
                            Toast.makeText(DummySaleReportActivity.this, "Volly Error", Toast.LENGTH_LONG).show();
                        }
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(DummySaleReportActivity.this);
        requestQueue.add(stringRequest);
    }

    private void setAdapter(){
        DummySalesReportAdapter sAdpater=new DummySalesReportAdapter(itemList);
    ...
    private void onClick(){
        ...
        imgHome.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(DummySaleReportActivity.this,DashBoardActivity.class);
    ...
    private void searchDialog() {
        AlertDialog.Builder dialogBuilder = new AlertDialog.Builder(DummySaleReportActivity.this, R.style.CustomDialogNew);
