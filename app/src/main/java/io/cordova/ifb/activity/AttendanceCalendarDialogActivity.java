...
import io.cordova.ifb.databinding.ActivityAttemdanceReportBinding;
import io.cordova.ifb.databinding.ActivityAttendanceReportDialogBinding;
import io.cordova.ifb.module.DialogItemModule;
import io.cordova.ifb.utility.AppController;
import io.cordova.ifb.utility.PrefManager;
import io.cordova.ifb.utility.Util;

public class AttendanceCalendarDialogActivity extends AppCompatActivity implements OnNavigationButtonClickedListener {
    ActivityAttendanceReportDialogBinding binding;
    ...
    private void initView(){
        prefManager=new PrefManager(AttendanceCalendarDialogActivity.this);
        ...
        binding.imgHome.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(AttendanceCalendarDialogActivity.this,NewDashboardActivity.class);
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (responseStatus) {
                                ...
                                Toast.makeText(AttendanceCalendarDialogActivity.this, "No data found", Toast.LENGTH_LONG).show();
                            ...
                            e.printStackTrace();
                            Toast.makeText(AttendanceCalendarDialogActivity.this, "Volly Error", Toast.LENGTH_LONG).show();
                        }
...
//        requestQueue.add(stringRequest);
    ...
    private void getAttendanceNav(String finYear,String m,Calendar calendar) {
        ProgressDialog pd=new ProgressDialog(AttendanceCalendarDialogActivity.this);
        pd.setCancelable(false);
        pd.setMessage("Loading");
        pd.show();
        HashMap<Integer, Object> dateHashmap = new HashMap<>();
