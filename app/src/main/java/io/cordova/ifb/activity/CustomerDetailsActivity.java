...
public class CustomerDetailsActivity extends AppCompatActivity {
    ...
    private void getItemlist(){
        ...
        String surl =  AppController.APIV2URL+"api/get_CustomerContactListByUser?Code="+prefManager.getUserCode()+"&PhoneNo=0&Operation=1&SecurityCode="+prefManager.getSecurityCode();
...
//        requestQueue.add(stringRequest);
        ...
        RequestQueue requestQueue =
                AppController.getUnsafeOkHttpQueue(CustomerDetailsActivity.this);
