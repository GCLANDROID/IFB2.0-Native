...
public class SalesReturnActivity extends AppCompatActivity {
    ...
    private void initialize(){
        prefManager=new PrefManager(SalesReturnActivity.this);
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            e.printStackTrace();
                            Toast.makeText(SalesReturnActivity.this, "Volly Error", Toast.LENGTH_LONG).show();
                        }
...
//        requestQueue.add(stringRequest);
        ...
        RequestQueue requestQueue =
                AppController.getUnsafeOkHttpQueue(SalesReturnActivity.this);
    ...
    private void onClick(){
        ...
        imgHome.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(SalesReturnActivity.this,DashBoardActivity.class);
    ...
    private void postSalesReturn(){
        String surl = AppController.APIV2URL+"api/post_SalesExchange?TicketNo="+etTicket.getText().toString()+"&Remarks="+etRemarks.getText().toString().replaceAll("\\s+","-")+"&UserID="+prefManager.getUserId()+"&SecurityCode="+prefManager.getSecurityCode();
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, surl,
            ...
            public void onErrorResponse(VolleyError error) {
                progressBar.dismiss();
                Toast.makeText(SalesReturnActivity.this, "volly 2" + error.toString(), Toast.LENGTH_LONG).show();
...
//        requestQueue.add(stringRequest);
    ...
    private void successAlert() {
        AlertDialog.Builder dialogBuilder = new AlertDialog.Builder(SalesReturnActivity.this, R.style.CustomDialogNew);
