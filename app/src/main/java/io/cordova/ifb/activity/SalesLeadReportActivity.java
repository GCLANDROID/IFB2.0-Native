...
import io.cordova.ifb.adapter.SalesLeadReportAdapter;
import io.cordova.ifb.module.CallingReportModel;
import io.cordova.ifb.utility.AppController;
import io.cordova.ifb.utility.PrefManager;

public class SalesLeadReportActivity extends AppCompatActivity {
    ...
    private void initialize(){
        prefManager=new PrefManager(SalesLeadReportActivity.this);
        rvReport=(RecyclerView)findViewById(R.id.rvReport);
        LinearLayoutManager layoutManager
                = new LinearLayoutManager(SalesLeadReportActivity.this, LinearLayoutManager.VERTICAL, false);
    ...
    private void getItemlist(){
        ...
        String surl =  AppController.APIURL+"api/get_CustomerCallingSalesLead?FinancialYear="+financialYear+"&Month="+month+"&UserID="+prefManager.getUserId()+"&Operation=2&SecurityCode="+prefManager.getSecurityCode();
                        ...
                        try {
                            ...
                            if (responseStatus) {
                                ...
                                for (int i = 0; i < responseData.length(); i++) {
                                    ...
                                    String CallToken=obj.optString("SalesLeadToken");
                                    String CallConnectedStatus=obj.optString("Saleslead_Status");
                                    ...
                                    String EntryDate=obj.optString("Saleslead_update_Date");
                                    ...
                                    calModel.setTicketNo(TicketNumber);
                            ...
                            e.printStackTrace();
                            Toast.makeText(SalesLeadReportActivity.this, "Volly Error", Toast.LENGTH_LONG).show();
                        }
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(SalesLeadReportActivity.this);
        requestQueue.add(stringRequest);
    }

    private void setAdapter(){
        SalesLeadReportAdapter sAdpater=new SalesLeadReportAdapter(itemList);
    ...
    private void onClick(){
        ...
        imgHome.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(SalesLeadReportActivity.this,DashBoardActivity.class);
    ...
    private void searchDialog() {
        AlertDialog.Builder dialogBuilder = new AlertDialog.Builder(SalesLeadReportActivity.this, R.style.CustomDialogNew);
