...
import io.cordova.ifb.adapter.SalesReportAdapter;
import io.cordova.ifb.databinding.ActivityAcProductScanBinding;
...
public class AcProductScanActivity extends AppCompatActivity {
    ActivityAcProductScanBinding binding;
    ...
    ACScanAdapter sAdpater;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding= DataBindingUtil.setContentView(this,R.layout.activity_ac_product_scan);
        initView();
    }

    private void initView(){
        prefManager=new PrefManager(AcProductScanActivity.this);
        ...
        LinearLayoutManager layoutManager
                = new LinearLayoutManager(AcProductScanActivity.this, LinearLayoutManager.VERTICAL, false);
    ...
    private void setModel() {
        String surl = AppController.APIV2URL + "api/CommonDDL?ModuleNo=18M&ID=IFBPC1000001&ID1=0&ID2=" + prefManager.getBranchId() + "&ID3=0&SecurityCode=" + prefManager.getSecurityCode();
                        ...
                        try {
                            ...
                            if (responseStatus) {
                                ...
                                for (int i = 0; i < responseData.length(); i++) {
                                 ...
                                 sAdpater=new ACScanAdapter(itemList,AcProductScanActivity.this);
                            ...
                            e.printStackTrace();
                            Toast.makeText(AcProductScanActivity.this, "Volly Error", Toast.LENGTH_LONG).show();
                        }
...
//        RequestQueue requestQueue = Volley.newRequestQueue(AcProductScanActivity.this);
//        requestQueue.add(stringRequest);

        RequestQueue requestQueue =
                AppController.getUnsafeOkHttpQueue(AcProductScanActivity.this);
    ...
    private void postSave(JSONObject jsonObject) {
        ...
        final ProgressDialog pd = new ProgressDialog(AcProductScanActivity.this);
                ...
                .getAsJSONObject(new JSONObjectRequestListener() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            if (responseStatus){
                                showProductStatusDialog(AcProductScanActivity.this, job1);
                                selectedArray = new JSONArray();
                            }else {
                                Toast.makeText(AcProductScanActivity.this, "Failed to save data", Toast.LENGTH_LONG).show();
                            }
                        } catch (Exception e) {
                            e.printStackTrace();
                        }
                    ...
                    public void onError(ANError error) {
                        ...
                        pd.dismiss();
                        Toast.makeText(AcProductScanActivity.this, "Error Occured 1", Toast.LENGTH_LONG).show();
                    }
                });
    }

    private void successAlert() {
        AlertDialog.Builder dialogBuilder = new AlertDialog.Builder(AcProductScanActivity.this, R.style.CustomDialogNew);
        LayoutInflater inflater = (LayoutInflater) getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        View dialogView = inflater.inflate(R.layout.dialog_success, null);
        dialogBuilder.setView(dialogView);
        TextView tvInvalidDate = (TextView) dialogView.findViewById(R.id.tvSuccess);
        tvInvalidDate.setText("Air conditoner has been added successfully");
