...
import io.cordova.ifb.adapter.CollaboartionReportAdapter;
import io.cordova.ifb.module.CollaborationModel;
import io.cordova.ifb.utility.AppController;
import io.cordova.ifb.utility.PrefManager;

public class CollaborationReportActivity extends AppCompatActivity {

    RecyclerView rvReport;
    ArrayList<CollaborationModel> reportList = new ArrayList<>();
    String month;
    String year;
    LinearLayout llLoader, llMain, llAgain, llNoData, llSearch;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_collaboration_report);
        initialize();
        getItem();
        onclick();
    }
    ...
    private void initialize() {
        prefManager = new PrefManager(CollaborationReportActivity.this);
        rvReport = (RecyclerView) findViewById(R.id.rvReport);
        LinearLayoutManager layoutManager
                = new LinearLayoutManager(CollaborationReportActivity.this, LinearLayoutManager.VERTICAL, false);
    ...
    private void getItem() {
        ...
        String surl =  AppController.APIURL+"api/gcl_EmployeeCollaborationQuestion?AEMEmployeeID="+prefManager.getUserId()+"&FinancialYear="+financialYear+"&Month="+month+"&SecurityCode="+prefManager.getSecurityCode();
                        ...
                        try {
                            ...
                            if (responseStatus) {
                                ...
                                for (int i = 0; i < responseData.length(); i++) {
                                    ...
                                    String Date_Of_Intraction = obj.optString("Date_Of_Intraction");
                                    String EntryDate = obj.optString("EntryDate");
                                    String Question = obj.optString("Question");
                                    String Answer = obj.optString("Answer");


                                    CollaborationModel obj2 = new CollaborationModel(Date_Of_Intraction,EntryDate,Question,Answer);
                                    reportList.add(obj2);
                            ...
                            e.printStackTrace();
                            Toast.makeText(CollaborationReportActivity.this, "Volly Error", Toast.LENGTH_LONG).show();
                        }
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(CollaborationReportActivity.this);
        requestQueue.add(stringRequest);
    }

    private void setAdapter() {
        CollaboartionReportAdapter aAdapter = new CollaboartionReportAdapter(reportList);
    ...
    private void onclick() {
        ...
        imgHome.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(CollaborationReportActivity.this,NewDashboardActivity.class);
    ...
    private void searchDialog() {
        AlertDialog.Builder dialogBuilder = new AlertDialog.Builder(CollaborationReportActivity.this, R.style.CustomDialogNew);
