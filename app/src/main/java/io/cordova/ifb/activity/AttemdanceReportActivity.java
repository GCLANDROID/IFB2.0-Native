...
public class AttemdanceReportActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_attemdance_report);
        initialize();
        getItem();
    ...
    private void initialize() {
        prefManager = new PrefManager(AttemdanceReportActivity.this);
        rvReport = (RecyclerView) findViewById(R.id.rvReport);
        LinearLayoutManager layoutManager
                = new LinearLayoutManager(AttemdanceReportActivity.this, LinearLayoutManager.VERTICAL, false);
                        ...
                        try {
                            ...
                            if (responseStatus) {
                                ...
                                for (int i = 0; i < responseData.length(); i++) {
                                    ...
                                    String CheckOutStatus=obj.optString("CheckOutStatus");

                                    ReportModule obj2 = new ReportModule(Date, LoginID, Day, Time, Address, Status);
                                    obj2.setCheckOutStatus(CheckOutStatus);
                                    reportList.add(obj2);
                            ...
                            e.printStackTrace();
                            Toast.makeText(AttemdanceReportActivity.this, "Volly Error", Toast.LENGTH_LONG).show();
                        }
    ...
    private void setAdapter() {
        AttedanceReportAdapter aAdapter = new AttedanceReportAdapter(reportList);
    ...
    private void searchDialog() {
        AlertDialog.Builder dialogBuilder = new AlertDialog.Builder(AttemdanceReportActivity.this, R.style.CustomDialogNew);
