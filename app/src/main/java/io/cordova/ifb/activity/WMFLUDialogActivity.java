...
import io.cordova.ifb.adapter.WMFLUDialogItemAdapter;
import io.cordova.ifb.adapter.WMFLUDialogItemForDataAdapter;
...
public class WMFLUDialogActivity extends AppCompatActivity {
    ...
    RecyclerView rvItem;
    WMFLUDialogItemAdapter itemAdapter;
    ...
    private void initialize(){
        ...
        LinearLayoutManager layoutManager
                = new LinearLayoutManager(WMFLUDialogActivity.this, LinearLayoutManager.VERTICAL, false);
    ...
    private void getDialogItemList(String month,String financialYear){
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            e.printStackTrace();
                            Toast.makeText(WMFLUDialogActivity.this, "Volly Error", Toast.LENGTH_LONG).show();
                        }
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(WMFLUDialogActivity.this);
    ...
    public void updateItemStatus(int position, boolean status) {
        ...
        if (itemList.get(position).isSelected()==true) {
            item.add("IFBPC1000021"+"-"+itemList.get(position).getItemId());
            prefManager.saveWMFLUIfbSize(item.size());
        }else if (itemList.get(position).isSelected()==false){
            item.clear();
