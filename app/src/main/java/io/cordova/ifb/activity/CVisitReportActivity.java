...
import io.cordova.ifb.adapter.CvisitReportAdapter;
import io.cordova.ifb.module.CVisitModel;
import io.cordova.ifb.utility.AppController;
import io.cordova.ifb.utility.PrefManager;

public class CVisitReportActivity extends AppCompatActivity {
    ArrayList<CVisitModel> itemList=new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cvisit_report);
        initialize();
        getItemlist();
        onClick();
    }
    ...
    private void initialize(){
        prefManager=new PrefManager(CVisitReportActivity.this);
        rvReport=(RecyclerView)findViewById(R.id.rvReport);
        LinearLayoutManager layoutManager
                = new LinearLayoutManager(CVisitReportActivity.this, LinearLayoutManager.VERTICAL, false);
    ...
    private void getItemlist(){
        ...
        String surl =  AppController.APIURL+"api/get_EmployeeCustomerVisitReport?ZoneId=0&BranchId=0&AEMEmployeeId="+prefManager.getUserId()+"&FinancialYear="+financialYear+"&Month="+month+"&Operation=1&SecurityCode="+prefManager.getSecurityCode();
                        ...
                        try {
                            ...
                            if (responseStatus) {
                                ...
                                for (int i = 0; i < responseData.length(); i++) {
                                    ...
                                    String VisitDate=obj.optString("VisitDate");
                                    ...
                                    String CustomerAddress=obj.optString("CustomerAddress");
                                    String CustomerRemarks=obj.optString("CustomerRemarks");
                                    String WithServiceEngineer=obj.optString("WithServiceEngineer");
                                    String ServiceEngName=obj.optString("ServiceEngName");
                                    String ServiceEngPhNo=obj.optString("ServiceEngPhNo");
                                    String VisitFileNameURL=obj.optString("VisitFileNameURL");
                                    String GeoLocation=obj.optString("GeoLocation");


                                    CVisitModel obj2 = new CVisitModel(VisitDate,CustomerName,CustomerPhNo,CustomerEmail,CategoryName,ModelName,WithServiceEngineer,ServiceEngName,ServiceEngPhNo,GeoLocation,VisitFileNameURL,CustomerAddress,CustomerRemarks);
                                    itemList.add(obj2);
                            ...
                            e.printStackTrace();
                            Toast.makeText(CVisitReportActivity.this, "Volly Error", Toast.LENGTH_LONG).show();
                        }
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(CVisitReportActivity.this);
        requestQueue.add(stringRequest);
    }

    private void setAdapter(){
        CvisitReportAdapter sAdpater=new CvisitReportAdapter(itemList,CVisitReportActivity.this);
    ...
    private void searchDialog() {
        AlertDialog.Builder dialogBuilder = new AlertDialog.Builder(CVisitReportActivity.this, R.style.CustomDialogNew);
