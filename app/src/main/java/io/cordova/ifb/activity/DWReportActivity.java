...
import io.cordova.ifb.adapter.DWReportAdapter;
import io.cordova.ifb.module.DWReportModel;
import io.cordova.ifb.utility.AppController;
import io.cordova.ifb.utility.PrefManager;

public class DWReportActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_d_w_report);
        initialize();
        getItemlist();
        onClick();
    }
    ...
    private void initialize(){
        prefManager=new PrefManager(DWReportActivity.this);
        rvReport=(RecyclerView)findViewById(R.id.rvReport);
        LinearLayoutManager layoutManager
                = new LinearLayoutManager(DWReportActivity.this, LinearLayoutManager.VERTICAL, false);
    ...
    private void getItemlist(){
        ...
        String surl =  AppController.APIURL+"api/get_EmployeeCampaign?AEMEmployeeID="+prefManager.getUserId()+"&FinYear="+financialYear+"&Month="+month+"&SecurityCode="+prefManager.getSecurityCode();
                        ...
                        try {
                            ...
                            if (responseStatus) {
                                ...
                                for (int i = 0; i < responseData.length(); i++) {
                                    ...
                                    String CustomerPhone=obj.optString("CustomerPhone");
                                    ...
                                    String AdvanceReceived=obj.optString("AdvanceReceived");
                                    String BookingAmount=obj.optString("BookingAmount");
                                    String Remarks=obj.optString("Remarks");



                                    DWReportModel obj2 = new DWReportModel(SalesDate,CustomerName,CustomerPhone,CustomerAddress,CategoryName,ModelName,AdvanceReceived,BookingAmount,Remarks);
                                    itemList.add(obj2);
                            ...
                            e.printStackTrace();
                            Toast.makeText(DWReportActivity.this, "Volly Error", Toast.LENGTH_LONG).show();
                        }
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(DWReportActivity.this);
        requestQueue.add(stringRequest);
    }

    private void setAdapter(){
        DWReportAdapter sAdpater=new DWReportAdapter(itemList,DWReportActivity.this);
    ...
    private void onClick(){
        ...
        imgHome.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(DWReportActivity.this,NewDashboardActivity.class);
    ...
    private void searchDialog() {
        AlertDialog.Builder dialogBuilder = new AlertDialog.Builder(DWReportActivity.this, R.style.CustomDialogNew);
