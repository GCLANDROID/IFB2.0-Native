...
public class TLSalesReportActivity extends AppCompatActivity implements RecyclerItemClickListener.OnItemClickListener {
    int y;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tlsales_report);
        initialize();
        getReportList();
        onClick();
    }
    ...
    private void initialize(){
        prefManager=new PrefManager(TLSalesReportActivity.this);
        rvReport=(RecyclerView)findViewById(R.id.rvReport);
        LinearLayoutManager layoutManager
                = new LinearLayoutManager(TLSalesReportActivity.this, LinearLayoutManager.VERTICAL, false);
                        ...
                        try {
                            ...
                            if (responseStatus) {
                                ...
                                for (int i = 0; i < responseData.length(); i++) {
                                    ...
                                    TLSaleModel obj2 = new TLSaleModel(Month,FinancialYear,Url);
                                    itemList.add(obj2);
                            ...
                            e.printStackTrace();
                            Toast.makeText(TLSalesReportActivity.this, "Volly Error", Toast.LENGTH_LONG).show();
                        }
...
//        requestQueue.add(stringRequest);
    ...
    private void setAdapter(){
        TLSaleAdapter tAdapter=new TLSaleAdapter(itemList);
    ...
    public void onItemClick(View childView, int position) {
        dLink = itemList.get(position).getUrl();
        operBrowser();
    ...
    private void onClick(){
        ...
        imgHome.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(TLSalesReportActivity.this,DashBoardActivity.class);
                startActivity(intent);
                finish();
            }
        });
    ...
    private void searchDialog() {
        AlertDialog.Builder dialogBuilder = new AlertDialog.Builder(TLSalesReportActivity.this, R.style.CustomDialogNew);
