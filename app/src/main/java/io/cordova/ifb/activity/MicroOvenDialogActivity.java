...
import io.cordova.ifb.adapter.MicroOvenDialogItemAdapter;
import io.cordova.ifb.adapter.MicroOvenDialogItemForDataAdapter;
...
public class MicroOvenDialogActivity extends AppCompatActivity {
    ...
    private void getDialogItemList(String month,String financialYear) {
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            e.printStackTrace();
                            Toast.makeText(MicroOvenDialogActivity.this, "Volly Error", Toast.LENGTH_LONG).show();
                        }
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(MicroOvenDialogActivity.this);
