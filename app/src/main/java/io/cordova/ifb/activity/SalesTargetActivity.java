...
import io.cordova.ifb.adapter.TargetAdapter;
import io.cordova.ifb.module.TargetModule;
import io.cordova.ifb.utility.AppController;
import io.cordova.ifb.utility.PrefManager;

public class SalesTargetActivity extends AppCompatActivity {
    ArrayList<TargetModule>itemList=new ArrayList<>();
    RecyclerView rvTarget;
    LinearLayout llMain,llNoData,llAgain,llLoader,llSearch;
    ...
    private void initialize(){
        prefManager=new PrefManager(SalesTargetActivity.this);
        rvTarget=(RecyclerView)findViewById(R.id.rvTarget);
        LinearLayoutManager layoutManager
                = new LinearLayoutManager(SalesTargetActivity.this, LinearLayoutManager.VERTICAL, false);
    ...
    private void getTargetList(){
                        ...
                        try {
                            ...
                            if (responseStatus) {
                                ...
                                for (int i = 0; i < responseData.length(); i++) {
                                    ...
                                    TargetModule obj2 = new TargetModule(CategoryName,Target);
                                    itemList.add(obj2);
                            ...
                            e.printStackTrace();
                            Toast.makeText(SalesTargetActivity.this, "Volly Error", Toast.LENGTH_LONG).show();
                        }
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(SalesTargetActivity.this);
        requestQueue.add(stringRequest);

    }

    private void setAdapter(){
        TargetAdapter tAdapter=new TargetAdapter(itemList);
        rvTarget.setAdapter(tAdapter);
    ...
    private void onClick(){
        ...
        imgHome.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(SalesTargetActivity.this,DashBoardActivity.class);
    ...
    private void searchDialog() {
        AlertDialog.Builder dialogBuilder = new AlertDialog.Builder(SalesTargetActivity.this, R.style.CustomDialogNew);
