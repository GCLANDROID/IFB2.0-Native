...
import io.cordova.ifb.adapter.SalesLeadAdapter;
import io.cordova.ifb.module.SalesLeadModel;
import io.cordova.ifb.utility.AppController;
import io.cordova.ifb.utility.PrefManager;

public class SalesLeadActivity extends AppCompatActivity {
    ...
    private void initView(){
        prefManager=new PrefManager(SalesLeadActivity.this);
        rvItem=(RecyclerView)findViewById(R.id.rvItem);
        LinearLayoutManager layoutManager
                = new LinearLayoutManager(SalesLeadActivity.this, LinearLayoutManager.VERTICAL, false);
    ...
    private void onClick(){
        ...
        imgHome.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(SalesLeadActivity.this,DashBoardActivity.class);
        ...
        llReport.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(SalesLeadActivity.this,SalesLeadReportActivity.class);
    ...
    private void getItemlist(){
        ...
        String surl = AppController.APIURL+"api/get_CustomerCallingSalesLead?FinancialYear="+financialYear+"&Month="+month+"&UserID="+prefManager.getUserId()+"&Operation=1&SecurityCode="+prefManager.getSecurityCode();
                        ...
                        try {
                            ...
                            if (responseStatus) {
                                ...
                                for (int i = 0; i < responseData.length(); i++) {
                                    ...
                                    String Call_Update_Date=obj.optString("Call_Update_Date");


                                    SalesLeadModel calModel=new SalesLeadModel(CallToken,CustomerName,CustomerPhNo,Call_Update_Date);
                            ...
                            e.printStackTrace();
                            Toast.makeText(SalesLeadActivity.this, "Volly Error", Toast.LENGTH_LONG).show();
                        }
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(SalesLeadActivity.this);
        requestQueue.add(stringRequest);
    }

    private void setAdapter(){
        SalesLeadAdapter sAdpater=new SalesLeadAdapter(itemList,SalesLeadActivity.this);
        rvItem.setAdapter(sAdpater);
    }

    private void searchDialog() {
        AlertDialog.Builder dialogBuilder = new AlertDialog.Builder(SalesLeadActivity.this, R.style.CustomDialogNew);
