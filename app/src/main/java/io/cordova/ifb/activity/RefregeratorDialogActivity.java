...
public class RefregeratorDialogActivity extends AppCompatActivity {
    ...
    private void initialize() {
        ...
        prefManager = new PrefManager(RefregeratorDialogActivity.this);

        rvItem = (RecyclerView) findViewById(R.id.rvItem);
        LinearLayoutManager layoutManager
                = new LinearLayoutManager(RefregeratorDialogActivity.this, LinearLayoutManager.VERTICAL, false);
    ...
    private void getDialogItemList(String month,String financialYear) {
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            e.printStackTrace();
                            Toast.makeText(RefregeratorDialogActivity.this, "Volly Error", Toast.LENGTH_LONG).show();
                        }
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(RefregeratorDialogActivity.this);
        requestQueue.add(stringRequest);

    }

    private void setAdapter() {
        itemAdapter = new RefrigeratorDialogItemAdapter(itemList, RefregeratorDialogActivity.this);
        rvItem.setAdapter(itemAdapter);
        setAdapterForData();
    }

    private void setAdapterForData() {
       AirConditionerDialogItemForDataAdapter itemAdapter = new AirConditionerDialogItemForDataAdapter(itemListForData, RefregeratorDialogActivity.this);
    ...
    private void onClick() {
        llCancel.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                finish();
                item.clear();
                AppController.ifbrefsize=0;
                AppController.refid="0";
            }
        });
        ...
        llSave.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (item.size()>0){
                    AppController.ifbrefsize=item.size();
                    AppController.refid=itemId;
                }else {
                    if (itemListForData.size()>0){
                        AppController.ifbrefsize=itemListForData.size();
                        AppController.refid=itemId;
                    }else {
                        AppController.ifbrefsize=0;
                        AppController.refid="0";
