...
import io.cordova.ifb.adapter.WMTLDialogItemAdapter;
import io.cordova.ifb.adapter.WMTLDialogItemForDataAdapter;
...
public class WMTLDialogActivity extends AppCompatActivity {
    ...
    private void initialize() {
        ...
        LinearLayoutManager layoutManager
                = new LinearLayoutManager(WMTLDialogActivity.this, LinearLayoutManager.VERTICAL, false);
    ...
    private void getDialogItemList(String month,String financialYear) {
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            e.printStackTrace();
                            Toast.makeText(WMTLDialogActivity.this, "Volly Error", Toast.LENGTH_LONG).show();
                        }
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(WMTLDialogActivity.this);
    ...
    private void setAdapter() {
        itemAdapter = new WMTLDialogItemAdapter(itemList, WMTLDialogActivity.this);
        rvItem.setAdapter(itemAdapter);

        setAdapterForData();
    }
    private void setAdapterForData() {
       WMTLDialogItemForDataAdapter itemAdapter = new WMTLDialogItemForDataAdapter(itemListForData, WMTLDialogActivity.this);
    ...
    public void updateItemStatus(int position, boolean status) {
        ...
        if (itemList.get(position).isSelected() == true) {
            item.add("IFBPC1000025" + "-" + itemList.get(position).getItemId());
            prefManager.saveWMTLIFBSize(item.size());
        } else {
            item.clear();
        }
