...
import io.cordova.ifb.adapter.ClothsDialogItemAdapter;
import io.cordova.ifb.adapter.ClothsDialogItemForDataAdapter;
...
public class ClothsDryerDialogActivity extends AppCompatActivity {
    ...
    RecyclerView rvItem;
    ClothsDialogItemAdapter itemAdapter;
    LinearLayout llCancel;
    LinearLayout llMain, llLoader, llAgain,llSave;
    PrefManager prefManager;
    ArrayList<String> item = new ArrayList<>();
    String categoryID="IFBPC1000005";
    ...
    private void initialize() {
        ...
        LinearLayoutManager layoutManager
                = new LinearLayoutManager(ClothsDryerDialogActivity.this, LinearLayoutManager.VERTICAL, false);
    ...
    private void getDialogItemList(String month,String financialYear) {
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            e.printStackTrace();
                            Toast.makeText(ClothsDryerDialogActivity.this, "Volly Error", Toast.LENGTH_LONG).show();
                        }
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(ClothsDryerDialogActivity.this);
    ...
    private void setAdapter() {
        itemAdapter = new ClothsDialogItemAdapter(itemList, ClothsDryerDialogActivity.this);
        rvItem.setAdapter(itemAdapter);
        setAdapterForData();
    }
    private void setAdapterForData() {
        ClothsDialogItemForDataAdapter itemAdapter = new ClothsDialogItemForDataAdapter(itemListForData, ClothsDryerDialogActivity.this);
