...
import io.cordova.ifb.adapter.RefNoReportAdapter;
import io.cordova.ifb.module.RefNoModel;
import io.cordova.ifb.utility.AppController;
import io.cordova.ifb.utility.PrefManager;

public class RefNoReportActivity extends AppCompatActivity {
    ArrayList<RefNoModel> itemList = new ArrayList<>();
    ...
    private void initialize() {
        prefManager = new PrefManager(RefNoReportActivity.this);
        rvReport = (RecyclerView) findViewById(R.id.rvReport);
        LinearLayoutManager layoutManager
                = new LinearLayoutManager(RefNoReportActivity.this, LinearLayoutManager.VERTICAL, false);
        ...
        financialYear = getIntent().getStringExtra("year");
        ...
        subOperation = getIntent().getStringExtra("subOperation");
        llSearch.setVisibility(View.GONE);

        tvReport=(TextView)findViewById(R.id.tvReport);
        report=getIntent().getStringExtra("report");
        tvReport.setText(report+" Report");
    ...
    private void getItemlist() {
        ...
        String surl =  AppController.APIV2URL+"api/get_EmployeeSalesRefDetails?ReferenceNo=0&UserID=" + prefManager.getUserId() + "&FinancialYear=" + financialYear + "&Month=" + month + "&Operation=2&SubOperation=" + subOperation + "&SecurityCode=" + prefManager.getSecurityCode();
                        ...
                        try {
                            ...
                            if (responseStatus) {
                                ...
                                for (int i = 0; i < responseData.length(); i++) {
                                    ...
                                    String Delivery_Date = obj.optString("Delivery_Date");
                                    String Delivery_Remarks = obj.optString("Delivery_Remarks");
                                    String InvoiceFileNameURL = obj.optString("InvoiceCopyURL");
                                    String IsCancel = obj.optString("IsCancel");
                                    String ApprovalStatus = obj.optString("ApprovalStatus");
                                    String TicketNumber = obj.optString("TicketNumber");
                                    ...
                                    RefNoModel refModel = new RefNoModel(SalesEntryDate, ReferenceNo, ModelName, CustomerName, CustomerEmail, CustomerPhNo, Delivery_Date, Delivery_Remarks, InvoiceFileNameURL, IsCancel);
                                    refModel.setApprovalStatus(ApprovalStatus);
                                    refModel.setTicketNumber(TicketNumber);
                                    refModel.setTokenNumber(TokenNo);
                                    refModel.setCategoryName(CategoryName);
                                    refModel.setCsdSales(CSD_Sales);
                                    refModel.setCust_Conf_Stats(Cust_Conf_Stats);
                                    itemList.add(refModel);
                            ...
                            e.printStackTrace();
                            Toast.makeText(RefNoReportActivity.this, "Volly Error", Toast.LENGTH_LONG).show();
                        }
...
//        RequestQueue requestQueue = Volley.newRequestQueue(RefNoReportActivity.this);
//        requestQueue.add(stringRequest);
        RequestQueue requestQueue =
                AppController.getUnsafeOkHttpQueue(RefNoReportActivity.this);

        requestQueue.add(stringRequest);
    }

    private void setAdapter() {
        RefNoReportAdapter sAdpater = new RefNoReportAdapter(itemList, RefNoReportActivity.this);
    ...
    private void onClick() {
        ...
        imgHome.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(RefNoReportActivity.this, DashBoardActivity.class);
    ...
    private void searchDialog() {
        AlertDialog.Builder dialogBuilder = new AlertDialog.Builder(RefNoReportActivity.this, R.style.CustomDialogNew);
