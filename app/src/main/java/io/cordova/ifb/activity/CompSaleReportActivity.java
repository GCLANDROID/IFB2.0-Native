...
import io.cordova.ifb.adapter.CompSaleReportAdapter;
...
public class CompSaleReportActivity extends AppCompatActivity {
    ...
    private void initialize() {
        prefManager = new PrefManager(CompSaleReportActivity.this);
        rvReport = (RecyclerView) findViewById(R.id.rvReport);
        LinearLayoutManager layoutManager
                = new LinearLayoutManager(CompSaleReportActivity.this, LinearLayoutManager.VERTICAL, false);
    ...
    private void getReportList() {
        ...
        String surl =  AppController.APIV2URL+"api/get_CompetitorSalesCheckingByYrMonth?AEMEmployeeID=" + prefManager.getUserId() + "&FinancialYear=" + financialYear + "&Month=" + month + "&SecurityCode=" + prefManager.getSecurityCode();
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            e.printStackTrace();
                            Toast.makeText(CompSaleReportActivity.this, "Volly Error", Toast.LENGTH_LONG).show();
                        }
...
//        RequestQueue requestQueue = Volley.newRequestQueue(CompSaleReportActivity.this);
//        requestQueue.add(stringRequest);

        RequestQueue requestQueue =
                AppController.getUnsafeOkHttpQueue(CompSaleReportActivity.this);
    ...
    private void setAdapter() {
        CompSaleReportAdapter tAdapter = new CompSaleReportAdapter(itemList);
    ...
    private void searchDialog() {
        AlertDialog.Builder dialogBuilder = new AlertDialog.Builder(CompSaleReportActivity.this, R.style.CustomDialogNew);
