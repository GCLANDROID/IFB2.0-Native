...
public class CompetitorSaleActivity extends AppCompatActivity {
    RecyclerView rvItem;
    ...
    CompetitorSaleAdapter compAdapter;
    ...
    private void setAdapter() {
        Log.d("yuii", "opooopp");
        compAdapter = new CompetitorSaleAdapter(itemList, CompetitorSaleActivity.this);
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            e.printStackTrace();
                            Toast.makeText(CompetitorSaleActivity.this, "Volly Error", Toast.LENGTH_LONG).show();
                        }
    ...
    private void showDateDialog() {
        ...
        final DatePickerDialog dialog = new DatePickerDialog(CompetitorSaleActivity.this, android.R.style.Theme_Holo_Dialog, new DatePickerDialog.OnDateSetListener() {
            @Override
   ...
   /* private void postCompetorSale() {
    ...
    private void onClick() {
        ...
        imgHome.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(CompetitorSaleActivity.this, NewDashboardActivity.class);
    ...
    private void successAlert() {
        AlertDialog.Builder dialogBuilder = new AlertDialog.Builder(CompetitorSaleActivity.this, R.style.CustomDialogNew);
        ...
        btnOk.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                alerDialog1.dismiss();
                Intent intent = new Intent(CompetitorSaleActivity.this, CompSaleReportActivity.class);
                startActivity(intent);
                finish();
    ...
    private void compSaleAlert() {
        ...
        btnLate.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(CompetitorSaleActivity.this, SalesDashboardActivity.class);
                startActivity(intent);
                finish();
            }
        });
