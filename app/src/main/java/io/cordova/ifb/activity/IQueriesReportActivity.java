...
import io.cordova.ifb.adapter.IQueryReportAdapter;
import io.cordova.ifb.module.QueryModel;
import io.cordova.ifb.utility.AppController;
import io.cordova.ifb.utility.PrefManager;

public class IQueriesReportActivity extends AppCompatActivity {
    ArrayList<QueryModel>itemList=new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_iqueries_report);
        initialize();
        getItemlist();
        setAdapter();
        onClick();
    ...
    private void initialize(){
        prefManager=new PrefManager(IQueriesReportActivity.this);
        rvReport=(RecyclerView)findViewById(R.id.rvReport);
        LinearLayoutManager layoutManager
                = new LinearLayoutManager(IQueriesReportActivity.this, LinearLayoutManager.VERTICAL, false);
    ...
    private void getItemlist(){
        ...
        String surl =  AppController.APIV2URL+"api/get_EmployeeiQuery?UserID="+prefManager.getUserId()+"&FinancialYear="+financialYear+"&Month="+month+"&Operation=1&SecurityCode="+prefManager.getSecurityCode();
                        ...
                        try {
                            ...
                            if (responseStatus) {
                                ...
                                for (int i = 0; i < responseData.length(); i++) {
                                    ...
                                    String QueryDate=obj.optString("QueryDate");
                                    String Category=obj.optString("Category");
                                    String OtherProduct=obj.optString("OtherProduct");
                                    String ContactPerson=obj.optString("ContactPerson");
                                    String ContactNo=obj.optString("ContactNo");
                                    String LandLineNo=obj.optString("LandLineNo");
                                    String EmailID=obj.optString("EmailID");
                                    String Customer=obj.optString("Customer");
                                    String OtherCategory=obj.optString("OtherCategory");
                                    String NameOfOrganisation=obj.optString("NameOfOrganisation");
                                    String Address=obj.optString("Address");
                                    String Pincode=obj.optString("Pincode");
                                    String Remarks=obj.optString("Remarks");

                                    QueryModel obj2 = new QueryModel(QueryDate,Category,ContactPerson,ContactNo,LandLineNo,EmailID,Customer,Address,Pincode,Remarks,OtherProduct,OtherCategory,NameOfOrganisation);
                                     itemList.add(obj2);
                            ...
                            e.printStackTrace();
                            Toast.makeText(IQueriesReportActivity.this, "Volly Error", Toast.LENGTH_LONG).show();
                        }
...
//        RequestQueue requestQueue = Volley.newRequestQueue(IQueriesReportActivity.this);
//        requestQueue.add(stringRequest);

        RequestQueue requestQueue =
                AppController.getUnsafeOkHttpQueue(IQueriesReportActivity.this);

        requestQueue.add(stringRequest);
    }

    private void setAdapter(){
        IQueryReportAdapter sAdpater=new IQueryReportAdapter(itemList, IQueriesReportActivity.this);
    ...
    private void onClick(){
        ...
        imgHome.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(IQueriesReportActivity.this,DashBoardActivity.class);
    ...
    private void searchDialog() {
        AlertDialog.Builder dialogBuilder = new AlertDialog.Builder(IQueriesReportActivity.this, R.style.CustomDialogNew);
