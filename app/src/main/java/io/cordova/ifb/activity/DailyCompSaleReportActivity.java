...
import io.cordova.ifb.adapter.DailyCompSaleReportAdapter;
import io.cordova.ifb.module.CompSaleModel;
import io.cordova.ifb.utility.AppController;
import io.cordova.ifb.utility.PrefManager;

public class DailyCompSaleReportActivity extends AppCompatActivity {
    int y;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_comp_sale_report);
        initialize();
        showDateDialog();
        onClick();
    }
    ...
    private void initialize() {
        prefManager = new PrefManager(DailyCompSaleReportActivity.this);
        rvReport = (RecyclerView) findViewById(R.id.rvReport);
        LinearLayoutManager layoutManager
                = new LinearLayoutManager(DailyCompSaleReportActivity.this, LinearLayoutManager.VERTICAL, false);
        rvReport.setLayoutManager(layoutManager);
        // rvReport.addOnItemTouchListener(new RecyclerItemClickListener(TLSalesReportActivity.this, TLSalesReportActivity.this));
    ...
    private void getReportList(String date) {
        llLoader.setVisibility(View.VISIBLE);
        llMain.setVisibility(View.GONE);
        llNoData.setVisibility(View.GONE);
        llAgain.setVisibility(View.GONE);
        String surl =  AppController.APIV2URL+"api/get_DailyCompetitorSalesUpdatedDetails?AEMEmployeeID=" + prefManager.getUserId() + "&SalesDate="+date+"&Operation=1&SecurityCode=" + prefManager.getSecurityCode();
                        ...
                        try {
                            ...
                            if (responseStatus) {
                                ...
                                for (int i = 0; i < responseData.length(); i++) {
                                    ...
                                    String SalesDate = obj.optString("SalesDate");
                                    ...
                                    CSRRemarks = obj.optString("CSRRemarks");
                                    CompSaleModel compModel = new CompSaleModel();
                                    compModel.setCategory(CategoryName);
                                    compModel.setComapnanyname(CompanyName);
                                    compModel.setSalesDate(SalesDate);
                                    compModel.setQuant(Quantity);
                                    compModel.setSaleDate(SalesDate);
                            ...
                            e.printStackTrace();
                            Toast.makeText(DailyCompSaleReportActivity.this, "Volly Error", Toast.LENGTH_LONG).show();
                        }
        ...
        RequestQueue requestQueue =
                AppController.getUnsafeOkHttpQueue(DailyCompSaleReportActivity.this);

        requestQueue.add(stringRequest);
//        RequestQueue requestQueue = Volley.newRequestQueue(DailyCompSaleReportActivity.this);
//        requestQueue.add(stringRequest);
    ...
    private void setAdapter() {
        DailyCompSaleReportAdapter tAdapter = new DailyCompSaleReportAdapter(itemList);
        rvReport.setAdapter(tAdapter);
    ...
    private void searchDialog() {
        AlertDialog.Builder dialogBuilder = new AlertDialog.Builder(DailyCompSaleReportActivity.this, R.style.CustomDialogNew);
    ...
    private void compSaleAlert() {
        ...
        tvResponse.setText(responseText + "Do you update that");
    ...
    private void showDateDialog() {
        ...
        final DatePickerDialog dialog = new DatePickerDialog(DailyCompSaleReportActivity.this, android.R.style.Theme_Holo_Dialog, new DatePickerDialog.OnDateSetListener() {
            @Override
