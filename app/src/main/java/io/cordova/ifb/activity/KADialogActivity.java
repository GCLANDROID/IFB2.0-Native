...
import io.cordova.ifb.adapter.HobsDialogItemAdapter;
import io.cordova.ifb.adapter.HobsDialogItemForDataAdapter;
import io.cordova.ifb.module.DialogItemModule;
import io.cordova.ifb.utility.AppController;
import io.cordova.ifb.utility.PrefManager;

public class KADialogActivity extends AppCompatActivity {
    ArrayList<DialogItemModule> itemList = new ArrayList<>();
    RecyclerView rvItem;
    HobsDialogItemAdapter itemAdapter;
    ...
    private void getDialogItemList(String month,String financialYear) {
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            e.printStackTrace();
                            Toast.makeText(KADialogActivity.this, "Volly Error", Toast.LENGTH_LONG).show();
                        }
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(KADialogActivity.this);
    ...
    public void updateItemStatus(int position, boolean status) {
        ...
        if (itemList.get(position).isSelected() == true) {
            item.add("IFBPC1000035" + "-" + itemList.get(position).getItemId());
        } else {
            item.clear();
        }
