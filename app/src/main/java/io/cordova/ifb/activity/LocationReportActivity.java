...
import io.cordova.ifb.adapter.LocationAdapter;
...
public class LocationReportActivity extends AppCompatActivity {
    ...
    private void initialize(){
        prefManager=new PrefManager(LocationReportActivity.this);
        rvReport=(RecyclerView)findViewById(R.id.rvReport);
        LinearLayoutManager layoutManager
                = new LinearLayoutManager(LocationReportActivity.this, LinearLayoutManager.VERTICAL, false);
        rvReport.setLayoutManager(layoutManager);
     //   rvReport.addOnItemTouchListener(new RecyclerItemClickListener(LocationReportActivity.this, LocationReportActivity.this));
    ...
    private void getReportList(){
        ...
        String surl = AppController.APIV2URL+ "api/get_LocationReport?ZoneID=0&BranchID="+prefManager.getBranchId()+"&UserTypeID="+prefManager.getUserTypeId()+"&AEMEmployeeID="+prefManager.getUserId()+"&FinancialYear="+financialYear+"&Month="+month+"&LocationDate=0&WorkingStatus=4&SecurityCode="+prefManager.getSecurityCode();
                        ...
                        try {
                            ...
                            if (responseStatus) {
                                ...
                                for (int i = 0; i < responseData.length(); i++) {
                                    ...
                                    String LocationDate=obj.optString("LocationDate");
                                    String Address=obj.optString("Address");
                                    LocationModel obj2 = new LocationModel(LocationDate,Address);
                                    itemList.add(obj2);
                            ...
                            e.printStackTrace();
                            Toast.makeText(LocationReportActivity.this, "Volly Error", Toast.LENGTH_LONG).show();
                        }
...
//        RequestQueue requestQueue = Volley.newRequestQueue(LocationReportActivity.this);
//        requestQueue.add(stringRequest);
        RequestQueue requestQueue =
                AppController.getUnsafeOkHttpQueue(LocationReportActivity.this);
    ...
    private void setAdapter(){
        LocationAdapter locationAdapter=new LocationAdapter(itemList);
        rvReport.setAdapter(locationAdapter);
    }
    ...
    private void onClick(){
        ...
        imgHome.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(LocationReportActivity.this,DashBoardActivity.class);
    ...
    private void searchDialog() {
        AlertDialog.Builder dialogBuilder = new AlertDialog.Builder(LocationReportActivity.this, R.style.CustomDialogNew);
