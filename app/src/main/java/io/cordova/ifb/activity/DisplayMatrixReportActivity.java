...
import io.cordova.ifb.adapter.DisplayMatrixReportAdapter;
import io.cordova.ifb.module.DisplayMatrixReportModel;
import io.cordova.ifb.utility.AppController;
import io.cordova.ifb.utility.PrefManager;

public class DisplayMatrixReportActivity extends AppCompatActivity {
    RecyclerView rvItem;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_display_matrix_report);
        initView();
        getReportList();
        onClick();
    }
    ...
    private void initView(){
        prefManager=new PrefManager(DisplayMatrixReportActivity.this);
        rvItem=(RecyclerView)findViewById(R.id.rvItem);
        LinearLayoutManager layoutManager
                = new LinearLayoutManager(DisplayMatrixReportActivity.this, LinearLayoutManager.VERTICAL, false);
    ...
    private void getReportList() {
                           ...
                           String responseText = job1.optString("responseText");
                            ...
                            if (responseStatus) {
                                ...
                                for (int i = 0; i < responseData.length(); i++) {
                                    ...
                                    DisplayMatrixReportModel dModel=new DisplayMatrixReportModel(CategoryName,CompanyName,Quantity);
                                    itemList.add(dModel);
                            ...
                            e.printStackTrace();
                            Toast.makeText(DisplayMatrixReportActivity.this, "Volly Error", Toast.LENGTH_LONG).show();
                        }
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(DisplayMatrixReportActivity.this);
    ...
    private void setAdapter() {
        DisplayMatrixReportAdapter tAdapter = new DisplayMatrixReportAdapter(itemList,DisplayMatrixReportActivity.this);
        rvItem.setAdapter(tAdapter);

    }

    private void searchDialog() {
        AlertDialog.Builder dialogBuilder = new AlertDialog.Builder(DisplayMatrixReportActivity.this, R.style.CustomDialogNew);
