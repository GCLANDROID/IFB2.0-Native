...
import io.cordova.ifb.adapter.SalesReportDwnldAdapter;
import io.cordova.ifb.module.DownloadModel;
import io.cordova.ifb.utility.AppController;
import io.cordova.ifb.utility.PrefManager;


public class SalesReportDownldActivity extends AppCompatActivity {
    ArrayList<DownloadModel> itemList=new ArrayList<>();
    ...
    private void initialize(){
        prefManager=new PrefManager(SalesReportDownldActivity.this);
        rvReport=(RecyclerView)findViewById(R.id.rvReport);
        LinearLayoutManager layoutManager
                = new LinearLayoutManager(SalesReportDownldActivity.this, LinearLayoutManager.VERTICAL, false);
    ...
    private void getItemlist(){
        ...
        String surl =  AppController.APIV2URL+"api/get_EmployeeDummyActualSalesReport?UserID="+prefManager.getUserId()+"&FinancialYear="+financialYear+"&Month=0&Operation=2&SecurityCode="+prefManager.getSecurityCode();
                        ...
                        try {
                            ...
                            if (responseStatus) {
                                ...
                                for (int i = 0; i < responseData.length(); i++) {
                                    ...
                                    String SalesReportURL=obj.optString("SalesReportURL");


                                    DownloadModel obj2 = new DownloadModel(Month,SalesReportURL);
                                     itemList.add(obj2);
                            ...
                            e.printStackTrace();
                            Toast.makeText(SalesReportDownldActivity.this, "Volly Error", Toast.LENGTH_LONG).show();
                        }
...
//        RequestQueue requestQueue = Volley.newRequestQueue(SalesReportDownldActivity.this);
//        requestQueue.add(stringRequest);
        RequestQueue requestQueue =
                AppController.getUnsafeOkHttpQueue(SalesReportDownldActivity.this);

        requestQueue.add(stringRequest);
    }

    private void setAdapter(){
        SalesReportDwnldAdapter sAdpater=new SalesReportDwnldAdapter(itemList, SalesReportDownldActivity.this);
    ...
    private void onClick(){
        ...
        imgHome.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(SalesReportDownldActivity.this,DashBoardActivity.class);
    ...
    private void searchDialog() {
        AlertDialog.Builder dialogBuilder = new AlertDialog.Builder(SalesReportDownldActivity.this, R.style.CustomDialogNew);
