...
import io.cordova.ifb.activity.CookerDialogActivity;
import io.cordova.ifb.module.DialogItemModule;

public class CookerDialogItemAdapter extends RecyclerView.Adapter<CookerDialogItemAdapter.MyViewHolder> {
        ...
        myViewHolder.llMain.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (itemModel.isSelected()) {
                    ...
                    ((CookerDialogActivity) context).updateItemStatus(i, true );



                } else {
                    myViewHolder.llClicked.setVisibility(View.GONE);
                    ((CookerDialogActivity) context).updateItemStatus(i, false);
    ...
    public CookerDialogItemAdapter(ArrayList<DialogItemModule> itemList, Context context) {
