...
public class MicroOvenDialogItemForDataAdapter extends RecyclerView.Adapter<MicroOvenDialogItemForDataAdapter.MyViewHolder> {
    ...
    public MicroOvenDialogItemForDataAdapter(ArrayList<DialogItemModule> itemList, Context context) {
