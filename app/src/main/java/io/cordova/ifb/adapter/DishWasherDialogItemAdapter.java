...
import io.cordova.ifb.activity.DishwasherDialogActivity;
import io.cordova.ifb.module.DialogItemModule;

public class DishWasherDialogItemAdapter extends RecyclerView.Adapter<DishWasherDialogItemAdapter.MyViewHolder> {
        ...
        myViewHolder.llMain.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (itemModel.isSelected()) {
                    ...
                    ((DishwasherDialogActivity) context).updateItemStatus(i, true );
                } else {
                    myViewHolder.llClicked.setVisibility(View.GONE);
                    ((DishwasherDialogActivity) context).updateItemStatus(i, false);
    ...
    public DishWasherDialogItemAdapter(ArrayList<DialogItemModule> itemList, Context context) {
