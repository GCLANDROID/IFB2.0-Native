...
import io.cordova.ifb.activity.WMFLUDialogActivity;
import io.cordova.ifb.module.DialogItemModule;

public class WMFLUDialogItemAdapter extends RecyclerView.Adapter<WMFLUDialogItemAdapter.MyViewHolder> {
        ...
        myViewHolder.llMain.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (itemModel.isSelected()) {
                    ...
                    ((WMFLUDialogActivity) context).updateItemStatus(i, true );
                } else {
                    myViewHolder.llClicked.setVisibility(View.GONE);
                    ((WMFLUDialogActivity) context).updateItemStatus(i, false);
    ...
    public WMFLUDialogItemAdapter(ArrayList<DialogItemModule> itemList, Context context) {
