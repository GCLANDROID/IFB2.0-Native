...
import io.cordova.ifb.activity.ClothsDryerDialogActivity;
import io.cordova.ifb.module.DialogItemModule;

public class ClothsDialogItemAdapter extends RecyclerView.Adapter<ClothsDialogItemAdapter.MyViewHolder> {
        ...
        myViewHolder.llMain.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (itemModel.isSelected()) {
                    ...
                    ((ClothsDryerDialogActivity) context).updateItemStatus(i, true );
                } else {
                    myViewHolder.llClicked.setVisibility(View.GONE);
                    ((ClothsDryerDialogActivity) context).updateItemStatus(i, false);
    ...
    public ClothsDialogItemAdapter(ArrayList<DialogItemModule> itemList, Context context) {
