...
public class AirConditionerDialogItemForDataAdapter extends RecyclerView.Adapter<AirConditionerDialogItemForDataAdapter.MyViewHolder> {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        TextView tvItem;
        LinearLayout llMain,llClicked,llTick;
        CheckBox checkBox;
    ...
    public AirConditionerDialogItemForDataAdapter(ArrayList<DialogItemModule> itemList, Context context) {
