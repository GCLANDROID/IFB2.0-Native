...
import io.cordova.ifb.activity.OvenDialogActivity;
import io.cordova.ifb.module.DialogItemModule;

public class OvenDialogItemAdapter extends RecyclerView.Adapter<OvenDialogItemAdapter.MyViewHolder> {
        ...
        myViewHolder.llMain.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (itemModel.isSelected()) {
                    ...
                    ((OvenDialogActivity) context).updateItemStatus(i, true );



                } else {
                    myViewHolder.llClicked.setVisibility(View.GONE);
                    ((OvenDialogActivity) context).updateItemStatus(i, false);
    ...
    public OvenDialogItemAdapter(ArrayList<DialogItemModule> itemList, Context context) {
