...
public class HobsDialogItemForDataAdapter extends RecyclerView.Adapter<HobsDialogItemForDataAdapter.MyViewHolder> {
    ...
    public HobsDialogItemForDataAdapter(ArrayList<DialogItemModule> itemList, Context context) {
