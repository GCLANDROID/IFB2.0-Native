...
public class ClothsDialogItemForDataAdapter extends RecyclerView.Adapter<ClothsDialogItemForDataAdapter.MyViewHolder> {
    ...
    public ClothsDialogItemForDataAdapter(ArrayList<DialogItemModule> itemList, Context context) {
