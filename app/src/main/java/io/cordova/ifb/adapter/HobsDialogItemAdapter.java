...
import io.cordova.ifb.activity.KADialogActivity;
import io.cordova.ifb.module.DialogItemModule;

public class HobsDialogItemAdapter extends RecyclerView.Adapter<HobsDialogItemAdapter.MyViewHolder> {
        ...
        myViewHolder.llMain.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (itemModel.isSelected()) {
                    ...
                    ((KADialogActivity) context).updateItemStatus(i, true );
                } else {
                    myViewHolder.llClicked.setVisibility(View.GONE);
                    ((KADialogActivity) context).updateItemStatus(i, false);
    ...
    public HobsDialogItemAdapter(ArrayList<DialogItemModule> itemList, Context context) {
