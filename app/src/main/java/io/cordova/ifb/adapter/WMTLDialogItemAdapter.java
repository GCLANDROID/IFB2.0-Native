...
import io.cordova.ifb.activity.WMTLDialogActivity;
import io.cordova.ifb.module.DialogItemModule;

public class WMTLDialogItemAdapter extends RecyclerView.Adapter<WMTLDialogItemAdapter.MyViewHolder> {
        ...
        myViewHolder.llMain.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (itemModel.isSelected()) {
                    ...
                    ((WMTLDialogActivity) context).updateItemStatus(i, true );
                } else {
                    myViewHolder.llClicked.setVisibility(View.GONE);
                    ((WMTLDialogActivity) context).updateItemStatus(i, false);
    ...
    public WMTLDialogItemAdapter(ArrayList<DialogItemModule> itemList, Context context) {
