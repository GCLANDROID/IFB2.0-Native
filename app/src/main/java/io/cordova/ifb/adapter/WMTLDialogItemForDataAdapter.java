...
public class WMTLDialogItemForDataAdapter extends RecyclerView.Adapter<WMTLDialogItemForDataAdapter.MyViewHolder> {
    ...
    public WMTLDialogItemForDataAdapter(ArrayList<DialogItemModule> itemList, Context context) {
