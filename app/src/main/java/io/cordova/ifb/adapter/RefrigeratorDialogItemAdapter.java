...
import io.cordova.ifb.activity.RefregeratorDialogActivity;
import io.cordova.ifb.module.DialogItemModule;

public class RefrigeratorDialogItemAdapter extends RecyclerView.Adapter<RefrigeratorDialogItemAdapter.MyViewHolder> {
        ...
        myViewHolder.llMain.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (itemModel.isSelected()) {
                    ...
                    ((RefregeratorDialogActivity) context).updateItemStatus(i, true );



                } else {
                    myViewHolder.llClicked.setVisibility(View.GONE);
                    ((RefregeratorDialogActivity) context).updateItemStatus(i, false);
    ...
    public RefrigeratorDialogItemAdapter(ArrayList<DialogItemModule> itemList, Context context) {
