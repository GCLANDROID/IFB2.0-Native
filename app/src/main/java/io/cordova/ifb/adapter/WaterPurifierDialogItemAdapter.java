...
import io.cordova.ifb.activity.WaterPurifierDialogActivity;
import io.cordova.ifb.module.DialogItemModule;

public class WaterPurifierDialogItemAdapter extends RecyclerView.Adapter<WaterPurifierDialogItemAdapter.MyViewHolder> {
        ...
        myViewHolder.llMain.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (itemModel.isSelected()) {
                    ...
                    ((WaterPurifierDialogActivity) context).updateItemStatus(i, true );



                } else {
                    myViewHolder.llClicked.setVisibility(View.GONE);
                    ((WaterPurifierDialogActivity) context).updateItemStatus(i, false);
    ...
    public WaterPurifierDialogItemAdapter(ArrayList<DialogItemModule> itemList, Context context) {
