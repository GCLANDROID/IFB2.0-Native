...
import io.cordova.ifb.activity.WasherDryerDialogActivity;
import io.cordova.ifb.module.DialogItemModule;

public class WasherDryerDialogItemAdapter extends RecyclerView.Adapter<WasherDryerDialogItemAdapter.MyViewHolder> {
        ...
        myViewHolder.llMain.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (itemModel.isSelected()) {
                    ...
                    ((WasherDryerDialogActivity) context).updateItemStatus(i, true );
                } else {
                    myViewHolder.llClicked.setVisibility(View.GONE);
                    ((WasherDryerDialogActivity) context).updateItemStatus(i, false);
    ...
    public WasherDryerDialogItemAdapter(ArrayList<DialogItemModule> itemList, Context context) {
