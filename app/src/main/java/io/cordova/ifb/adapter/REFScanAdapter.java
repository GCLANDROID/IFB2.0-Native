...
import io.cordova.ifb.activity.RefProductScanActivity;
import io.cordova.ifb.module.ACModel;

public class REFScanAdapter extends RecyclerView.Adapter<REFScanAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder myViewHolder, final int i) {
        ...
        myViewHolder.imgPlus.setOnClickListener(v -> {
            ...
            try {
                ...
                RefProductScanActivity.selectedArray.put(obj);
            } catch (Exception e) {
                e.printStackTrace();
            }
        });
        ...
        myViewHolder.imgMinus.setOnClickListener(v -> {
            ...
            for (int j = 0; j < RefProductScanActivity.selectedArray.length(); j++) {
                try {
                    JSONObject obj = RefProductScanActivity.selectedArray.getJSONObject(j);
            ...
            RefProductScanActivity.selectedArray = newArray;
        });
    ...
    public REFScanAdapter(ArrayList<ACModel> itemList, Context context) {
