...
import io.cordova.ifb.activity.RefregeratorFFDialogActivity;
import io.cordova.ifb.module.DialogItemModule;

public class RefrigeratorFFDialogItemAdapter extends RecyclerView.Adapter<RefrigeratorFFDialogItemAdapter.MyViewHolder> {
        ...
        myViewHolder.llMain.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (itemModel.isSelected()) {
                    ...
                    ((RefregeratorFFDialogActivity) context).updateItemStatus(i, true );



                } else {
                    myViewHolder.llClicked.setVisibility(View.GONE);
                    ((RefregeratorFFDialogActivity) context).updateItemStatus(i, false);
    ...
    public RefrigeratorFFDialogItemAdapter(ArrayList<DialogItemModule> itemList, Context context) {
