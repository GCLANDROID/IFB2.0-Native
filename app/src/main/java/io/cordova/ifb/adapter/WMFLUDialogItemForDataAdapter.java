...
public class WMFLUDialogItemForDataAdapter extends RecyclerView.Adapter<WMFLUDialogItemForDataAdapter.MyViewHolder> {
    ...
    public WMFLUDialogItemForDataAdapter(ArrayList<DialogItemModule> itemList, Context context) {
