...
public class CompSaleReportAdapter extends RecyclerView.Adapter<CompSaleReportAdapter.MyViewHolder> {
    ...
    public CompSaleReportAdapter(ArrayList<CompSaleModel> itemList) {
